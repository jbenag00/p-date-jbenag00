...
public class MainDate
{
	public static void main(String args[])
	{
		...
		System.out.println("it is right the day "+date.getDay()+"?"+date.checkDaysOfMonth(date.getMonth()));
System.out.println("it is right the day "+date2.getDay()+"?"+date2.checkDaysOfMonth(date2.getMonth()));
